...
import { LucideAngularModule, Wallet, Mail, Lock, ArrowRight, Sparkles } from 'lucide-angular';
    ...
    <div class="auth-container">
      ...
      <div class="auth-card animate-scale-in">
        <div class="auth-header">
          ...
          <p class="auth-subtitle">Inicia sesión para gestionar tus finanzas</p>
        </div>
        <form (ngSubmit)="onSubmit()" #loginForm="ngForm">
          <div class="form-group">
            ...
            <input type="email" id="email" [(ngModel)]="credentials.email" name="email" required placeholder="tu@email.com" />
          </div>
          <div class="form-group">
            <label for="password">
            ...
            <input type="password" id="password" [(ngModel)]="credentials.password" name="password" required placeholder="Tu contraseña" />
          </div>
        ...
        <p class="auth-link">
          ¿No tienes cuenta? <a routerLink="/auth/register">Crea una gratis</a>
        </p>
      </div>
    </div>
  `,
